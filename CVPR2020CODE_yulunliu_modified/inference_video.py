...
counter_person = 1
def compute_flow_seg(flow_model, base, video, H, start):
...
def inference_video(input_video, output_folder):
    ...
    with torch.no_grad():
        ...
        for ite2 in range(int(nseg)):
            ...
            optic, video, mask, mask_object = compute_flow_seg(flow_model, base, video, H, ite2 * (SEG - 1))
...
if __name__ == '__main__':
    ...
    inference_video(input_video_path, output_folder)
